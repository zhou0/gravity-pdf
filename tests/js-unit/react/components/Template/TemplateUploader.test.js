...
describe('Template - TemplateUploader.js', () => {
  ...
  describe('Component functions', () => {
    ...
    test('onDrop() - Manages the template file upload', () => {
      const acceptedFiles = [
        {
  ...
  describe('Run Lifecycle methods', () => {
    ...
    test('componentWillReceiveProps() - Fires appropriate function based on Redux store data (success)', () => {
      nextProps = {
    ...
    test('componentWillReceiveProps() - Fires appropriate function based on Redux store data (error)', () => {
      nextProps = {
        templateUploadProcessingSuccess: {},
        templateUploadProcessingError: {
          response: {
