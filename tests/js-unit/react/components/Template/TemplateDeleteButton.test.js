...
describe('Template - TemplateDeleteButton.js', () => {
  ...
  describe('Run Lifecycle methods', () => {
    ...
    test('componentWillReceiveProps() - Fires appropriate action based on (success) Redux store data', () => {
      const nextProps = {
        getTemplateProcessing: 'success'
      }
      const wrapper = shallow(
    ...
    test('componentWillReceiveProps() - Fires appropriate action based on (failed) Redux store data', () => {
      const nextProps = {
