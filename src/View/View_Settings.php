...
class View_Settings extends Helper_Abstract_View {
	...
	public function add_tooltips( $tooltips ) {
		...
		$tooltips['pdf_allow_url_fopen']  = '<h6>' . esc_html__( 'Enable allow_url_fopen', 'gravity-forms-pdf-extended' ) . '</h6>' . esc_html__( 'This option enables the URL-aware fopen wrappers that enable accessing URL object like files.', 'gravity-forms-pdf-extended' );
